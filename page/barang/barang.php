...
<section class="content">
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    $stok = $conn->query("SELECT * FROM tb_pembelian  WHERE id_barang='$id_barang'");
    ...
    <a href="?page=barang&aksi=add" class="btn btn-xs btn-primary"><i class="fas fa-plus-circle"></i> Add Data</a>
